...
import { CHANGE_DATA, CHANGE_SEARCH, GET_DATA, GET_ROW, GET_ROW_SUCCESS, GET_LIST, GET_LIST_SUCCESS, GET_DATA_SUCCESS, CHANGE_ROW, DELETE_ROW } from './constants';
 ...
 * Get the entity row
 *
 * @return {object} An action object with a type of GET_ROW
 */
...
/**
 * Get the entity row data
 *
 * @return {object} An action object with a type of GET_ROW_SUCCESS
 */
 export function getRowSuccess(payload) {
  return {
