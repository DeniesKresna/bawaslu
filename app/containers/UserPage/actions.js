...
import { CHANGE_DATA, CHANGE_SEARCH, GET_DATA, GET_ROLES, GET_ROLES_SUCCESS, GET_DATA_SUCCESS, CHANGE_ROW, DELETE_ROW, RESET_ROW } from './constants';
 ...
 * Get the roles data
 *
 * @return {object} An action object with a type of GET_ROLES
 */
...
/**
 * success get roles data
 *
 * @param  {object} payload
 *
 * @return {object} An action object with a type of GET_ROLES_SUCCESS
 */
 ...
 * @param  {object} payload
 *
 * @return {object} An action object with a type of RESET_ROW
 */
 export function resetRow(payload) {
  return {
    type: RESET_ROW,
    payload
  };
