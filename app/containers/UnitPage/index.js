...
import { makeSelectData, makeSelectSearch, makeSelectIsLoading } from './selectors';
...
export function UnitPage({ data, search, isLoading, onGetData, onChangeSearch, onChangeData, onChangeRow, onDeleteRow }) {
  ...
  return (
    <div>
      <Helmet>
        <title>{entity}</title>
        <meta name="description" content="Pengaturan Satuan Barang Inventaris" />
      </Helmet>
